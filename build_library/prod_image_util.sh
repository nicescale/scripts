...
create_prod_image() {
  ...
  emerge_to_image "${root_fs_dir}" "net-analyzer/nmap"
  emerge_to_image "${root_fs_dir}" "net-libs/libpcap"
  emerge_to_image "${root_fs_dir}" "net-analyzer/tcpdump"
  emerge_to_image "${root_fs_dir}" "net-analyzer/netperf"
  emerge_to_image "${root_fs_dir}" "net-dialup/lrzsz"
  emerge_to_image "${root_fs_dir}" "net-misc/iperf"
  emerge_to_image "${root_fs_dir}" "sys-apps/file"
  emerge_to_image "${root_fs_dir}" "sys-process/psmisc"
